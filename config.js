...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~JrT1dspJCHiNCsQv4RtZ",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2348164849238",  // Owner's WhatsApp number
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*Active🤖*",  // Status reply message
