...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~h9RwSJYT#Nt2E6P_tf1MBMOuLYpDzrev9vyJ-kDMmlfggxxlEKXs",  // Your bot's session ID (keep it secure)
    PREFIX: process.env.PREFIX || ".",         // Command prefix (e.g., "., / ! * - +")
    BOT_NAME: process.env.BOT_NAME || "♥️𝐒𝐇𝐀𝐇𝐈𝐃 𝐊𝐈𝐍𝐆♥️",  // Bot's display name
    ...
    OWNER_NAME: process.env.OWNER_NAME || "♥️𝐒𝐇𝐀𝐇𝐈𝐃 𝐊𝐈𝐍𝐆♥️",           // Owner's name
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY S♥️𝐒𝐇𝐀𝐇𝐈𝐃 𝐊𝐈𝐍𝐆♥️ 🤍*",  // Status reply message
    ...
    STICKER_NAME: process.env.STICKER_NAME || "♥️𝐒𝐇𝐀𝐇𝐈𝐃 𝐊𝐈𝐍𝐆♥️",     // Sticker pack name
